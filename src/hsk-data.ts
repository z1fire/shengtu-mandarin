...
const coreGrammarPoints: GrammarPoint[] = [
  ...
  { group: "Questions", label: "Open question", title: "Question words stay in place", formula: "subject + verb + question word?", example: "你去哪儿？", pinyin: "Nǐ qù nǎr?", translation: "Where are you going?" },
  ...
  { group: "Place", label: "Existence", title: "There is with 有", formula: "place + 有 + number + measure word + noun", example: "学校里有一家书店。", pinyin: "Xuéxiào lǐ yǒu yì jiā shūdiàn.", translation: "There is a bookstore inside the school." },
  { group: "Place", label: "Position", title: "Use direction words", formula: "noun + 在 + place + 上 / 下 / 里 / 外", example: "书在桌子上。", pinyin: "Shū zài zhuōzi shàng.", translation: "The book is on the table." },
